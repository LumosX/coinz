...
class MailFragment : Fragment() {
    ...
    private val firstMessageCD = Triple("Boss Jackal", "Your f▩cking orders", """Oi, recruit,
        ...
        Your job's easy. Decrypt me those messages. I don't care how you do it, buy your own damn Compute. You can do that by collecting the crypto that's literally lying around on the street. Then you pay some hackers off (we've cut deals for cheaper Compute with 'em) and Bob's your damn uncle. We've given you a little boost of cash and compute to get you started though, so get right in there.
